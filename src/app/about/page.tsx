            ...
            <div className="max-w-5xl mx-auto">
                ...
                >
                    <div className="relative mb-12">
                        <motion.div
                            className="absolute inset-0 blur-3xl bg-gradient-to-r from-neon-cyan/20 via-neon-purple/20 to-neon-blue/20 opacity-50"
                            animate={{
                                opacity: [0.3, 0.5, 0.3],
                                scale: [1, 1.05, 1],
                            }}
                        ...
                        <div className="grid md:grid-cols-2 gap-6 mb-8">
                            {[
                                ...
                                >
                                    ...
                                    <p className="text-gray-400 text-sm">{thinker.insight}</p>
                                </motion.div>
                            ))}
                        </div>
                ...
                >
                    <div className="relative mb-12">
                        ...
                        <p className="text-center text-gray-400 text-lg">私たちが直面している課題</p>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-red-900/20 via-orange-900/20 to-red-900/20 rounded-3xl p-8 md:p-12 border border-red-500/30">
                        ...
                        <p className="text-gray-300 text-lg leading-relaxed">
                            多くの人が「AIが出した正解」を自らの意思だと錯覚し、独自の違和感や不合理な情熱を切り捨てている。このままでは、人間はアルゴリズムの隙間を埋めるだけの「効率的なパーツ」に成り下がってしまう。SZがStorytelling LLCを通じて対峙しているのは、この<span className="text-red-400 font-bold">「人間性の記号化」</span>という静かなる独裁である。
                        </p>
                    </div>
                </motion.section>
                ...
                >
                    ...
                    >
                        <p className="text-gray-200 text-xl leading-relaxed text-center font-light italic">
                            私は、あなたに「AIの使い方」を教えたいのではない。<br className="hidden md:block" />
                            AIという魔法の杖を手にしたあなたが、<br className="hidden md:block" />
                            <span className="text-neon-cyan font-bold not-italic">いかにして自らの人生の「絶対的な著者」であり続けるか。</span><br className="hidden md:block" />
                            そのための武器を、ここに置いておく。
                        </p>
                    </motion.div>
                </motion.section>
                ...
                >
                    ...
                    <div className="glass rounded-3xl p-8 md:p-12 neon-border">
                        <div className="flex items-center gap-4 mb-8">
                            ...
                            <div>
                                <h3 className="text-2xl font-black text-white">Profile: SZ（すず）</h3>
